...
const SECTIONS: { heading: string; body: string }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "- /projects:        https://openodia.com/projects — Open-source Odia language projects",
      "- /tools:           https://openodia.com/tools — Tool directory from Awesome-Odia-AI",
  ...
  },
  {
    heading: "Projects",
    body: [
      "OpenOdia aggregates GitHub repositories from the following organizations:",
      ...
      "- soumendrak/aidaybbsr2025demo — AI Day Bhubaneswar 2025 demo",
      "- soumendrak/odia-2048 — 2048 game in Odia",
      "",
