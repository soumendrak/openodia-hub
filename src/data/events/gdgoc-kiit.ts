...
export const gdgocKiitEvents: Omit<Event, "community">[] = [
  // auto-crawled
  {
    ...
    endDate: "2026-08-09",
    description: "Deploy or [REDACTED] is three good things happening back to back — a talk worth showing up for, a hackathon worth losing sleep over, and something you genuinely won't get to do anywhere else: hunting for real asteroids.",
  },
  // auto-crawled
  {
    year: "2026",
